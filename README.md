# Automa O De Truncagem De Logs D1223D

Aplicação backend `automa-o-de-truncagem-de-logs-d1223d` construída com foco em boas práticas de engenharia.

## Visão Geral
- Nome da aplicação: `automa-o-de-truncagem-de-logs-d1223d`
